...
/**
	...
	if(isset($_POST['click'])){
        ...
        $updated_at = date('Y-m-d g:i:h a', time());
	   ...
	   $msg = validate("All fields are required");
		...
		$msg = validate("Invalid Email");
		   ...
		   connection()-> query("UPDATE information SET name='$name', email='$email', cell='$cell', username='$username', location='$location', age='$age', designation='$designation', updated_at ='$updated_at' WHERE id='$id'");
    ...
    <input name="email" class="form-control" value="<?php echo $edit_data -> email;?>" type="text">
					...
					<div class="form-group">
						...
						<select class="form-control" name="location" id="">
							...
							<option <?php echo($edit_data -> location =='Banasree') ? 'selected' : ''; ?>
							 value="Banasree">Banasree</option>
					...
					<div class="form-group">
						...
						<select class="form-control" name="designation" id="">
							...
							<option <?php echo ($edit_data ->designation =='Professor')? 'selected' : '';?> value="Professor">Professor</option>
							<option <?php echo ($edit_data ->designation =='Lecturer')? 'selected' : '';?> value="Lecturer">Lecturer</option>
							<option <?php echo ($edit_data ->designation =='Mentor')? 'selected' : '';?> value="Mentor">Mentor</option>
							<option <?php echo ($edit_data ->designation =='Trainer')? 'selected' : '';?> value="Trainer">Trainer</option>
							<option <?php echo ($edit_data ->designation =='Instructor')? 'selected' : '';?> value="Instructor">Instructor</option>
